# Node-Express-Cassandra Project   ![Version][version-image]
...
```bash
$ git clone https://github.com/arjunkhetia/Node.Js-Express-Cassandra-Project.git
```
...
# Cassandra Database Connectivity (with connection pool)

A modern, feature-rich and highly tunable Node.js client library for Apache Cassandra. A Connection Pool is a cache of database connections maintained by your driver so that connections can be re-used when new connections to the database are required.
...
var  options = {
  ...
  encoding: {
      map: Map, // To use for Cassandra map type encoding and decoding.
      set: Set // To use for Cassandra set type encoding and decoding.
  }
};
...
![Monitoring Page](https://github.com/arjunkhetia/Node.Js-Express-Cassandra-Project/blob/master/public/status-monitor.png "Monitoring Page")
